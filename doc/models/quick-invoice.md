...
| `item_list` | [`List[ItemList]`](../../doc/models/item-list.md) | Optional | Item List<br><br>**Constraints**: *Minimum Items*: `1`, *Maximum Items*: `300`, *Unique Items Required* |
...
| `files` | [`List[File2]`](../../doc/models/file-2.md) | Optional | Files<br><br>> Maximum of 4 files & maximum size of 5MB per file.<br><br>**Constraints**: *Maximum Items*: `4` |
