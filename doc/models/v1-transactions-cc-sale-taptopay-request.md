...
| `card_data_cryptogram` | `str` | Required | Encrypted Cardholder data. Used in Tap to Pay transactions |
| `general_card_data` | `str` | Required | Plaintext EMV tags. Used in Tap to Pay transactions |
| `card_reader_id` | `str` | Optional | Identifier of card reader used in Tap to Pay transactions. |
