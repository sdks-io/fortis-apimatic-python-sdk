...
| `account_type` | `str` | Optional | Required for ACH transactions if account_vault_id is not provided.<br><br>> For ACH, allowed values are 'checking' or 'savings'. For CC, this field is read only. The system will identify card type and generate a value for this field automatically. possible values are: visa, mc, disc, amex, jcb, diners, and debit.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `32` |
...
| `auth_code` | `str` | Optional | Required on force transactions and EBT voucher clear sale/refund. Ignored for all other actions.<br><br>**Constraints**: *Minimum Length*: `6`, *Maximum Length*: `6` |
| `avs` | `Any` | Optional | - |
...
| `notification_phone` | `str` | Optional | Notification Phone. Country code not included |
...
| `rejected_transaction_ach_retries` | [`List[RejectedTransactionAchRetry]`](../../doc/models/rejected-transaction-ach-retry.md) | Optional | [object Object] |
...
| `is_retriable` | `bool` | Optional | [object Object] |
| `saved_account` | [`SavedAccount1`](../../doc/models/saved-account-1.md) | Optional | - |
| `balances` | [`List[Balance]`](../../doc/models/balance.md) | Optional | Additional amounts |
