...
| `item_list` | [`List[ItemList5]`](../../doc/models/item-list-5.md) | Optional | Item List<br><br>**Constraints**: *Minimum Items*: `1`, *Maximum Items*: `300`, *Unique Items Required* |
...
| `files` | [`List[File5]`](../../doc/models/file-5.md) | Optional | Files<br><br>> Maximum of 4 files & maximum size of 5MB per file.<br><br>**Constraints**: *Maximum Items*: `4` |
...
| `single_payment_max_amount` | `int` | Optional | Single Payment Max Amount |
| `cell_phone` | `str` | Optional | Cell Phone<br><br>**Constraints**: *Minimum Length*: `10`, *Maximum Length*: `10`, *Pattern*: `^\d{10}$` |
| `tags` | `List[str]` | Optional | Tags |
| `quick_invoice_c_1` | `str` | Optional | Custom field 1 for api users to store custom data<br><br>**Constraints**: *Maximum Length*: `128` |
| `quick_invoice_c_2` | `str` | Optional | Custom field 2 for api users to store custom data<br><br>**Constraints**: *Maximum Length*: `128` |
| `quick_invoice_c_3` | `str` | Optional | Custom field 1 for api users to store custom data<br><br>**Constraints**: *Maximum Length*: `128` |
| `auto_reopen` | `bool` | Optional | Auto Reopen. If set to true, a void, refund or detachment of a Transaction Payment will cause the QuickInvoice to be opened again |
