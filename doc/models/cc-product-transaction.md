...
| `card_type_ebt` | `bool` | Optional | Card Type EBT |
| `allow_ebt_cash_benefit` | `bool` | Optional | Allow EBT Cash Benefit |
| `allow_ebt_food_stamp` | `bool` | Optional | Allow EBT Food Stamp |
...
| `enable_3_ds` | `bool` | Optional | Enable 3DS |
...
| `allow_softpos` | `bool` | Optional | Allow Soft POS |
