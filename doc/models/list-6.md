...
| `parent_name` | `str` | Optional | Name of the parent location |
...
| `product_files` | [`List[ProductFile1]`](../../doc/models/product-file-1.md) | Optional | Product File Information on `expand` |
