...
```python
def createa_transaction_ach_retry(self,
                                 body,
                                 expand=None)
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`ResponseTransactionAchRetry`](../../doc/models/response-transaction-ach-retry.md).
...
```python
def listall_transaction_ach_retriesrelated(self,
                                          page=None,
                                          order=None,
                                          filter_by=None,
                                          expand=None,
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`ResponseTransactionAchRetrysCollection`](../../doc/models/response-transaction-ach-retrys-collection.md).
...
```python
def viewsingle_transaction_ach_retryrecord(self,
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `transaction_ach_retry_id` | `str` | Template, Required | Transaction ACH Retry ID.<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
| `expand` | [`List[Expand57]`](../../doc/models/expand-57.md) | Query, Optional | Most endpoints in the API have a way to retrieve extra data related to the current record being retrieved. For example, if the API request is for the accountvaults endpoint, and the end user also needs to know which contact the token belongs to, this data can be returned in the accountvaults endpoint request.<br><br>**Constraints**: *Unique Items Required* |
| `fields` | [`List[Field55]`](../../doc/models/field-55.md) | Query, Optional | You can use any `field_name` from this endpoint results to filter the list of fields returned on the response. |
