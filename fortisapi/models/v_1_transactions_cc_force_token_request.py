...
class V1TransactionsCcForceTokenRequest(object):
    """Implementation of the 'V1TransactionsCcForceTokenRequest' model.
    ...
    def __init__(
        ...
        if trans_id is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        account_vault_api_id =\
            ...
            if dictionary.get("account_vault_api_id")\
                else APIHelper.SKIP
        token_api_id =\
            dictionary.get("token_api_id")\
            if dictionary.get("token_api_id")\
                else APIHelper.SKIP
        cvv =\
            dictionary.get("cvv")\
        ...
        trans_id =\
            dictionary.get("trans_id")\
            if "trans_id" in dictionary.keys()\
                else APIHelper.SKIP
