...
class V1TransactionsCcRefundTaptopayRequest(object):
    """Implementation of the 'V1 Transactions Cc Refund Taptopay Request' model.
    ...
    def __init__(
        ...
        """Initialize a V1TransactionsCcRefundTaptopayRequest instance."""
