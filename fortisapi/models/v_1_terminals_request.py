...
class V1TerminalsRequest(object):
    """Implementation of the 'V1TerminalsRequest' model.
    ...
    def __repr__(self):
        ...
        _terminal_application_id=self.terminal_application_id
        _terminal_cvm_id=(
            self.terminal_cvm_id
            if hasattr(self, "terminal_cvm_id")
            else None
        )
        _terminal_manufacturer_code=self.terminal_manufacturer_code
        _title=self.title
        _mac_address=(
            self.mac_address
        ...
        _debit=self.debit
        _emv=self.emv
        _cashback_enable=self.cashback_enable
        _print_enable=self.print_enable
        _sig_capture_enable=self.sig_capture_enable
        _is_provisioned=(
            self.is_provisioned
