...
class V1TransactionsCcAvsOnlySwipedRequest(object):
    """Implementation of the 'V1 Transactions Cc Avs Only Swiped Request' model.
    ...
    def __init__(
        ...
        """Initialize a V1TransactionsCcAvsOnlySwipedRequest instance."""
