...
class V1TransactionsEbtVoucherClearSaleKeyedRequest(object):
    """Implementation of the 'V1TransactionsEbtVoucherClearSaleKeyedRequest' model.
    ...
    def __init__(
        ...
        """Initialize a V1TransactionsEbtVoucherClearSaleKeyedRequest instance."""
