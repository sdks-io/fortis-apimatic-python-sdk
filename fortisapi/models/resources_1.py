...
class Resources1(object):
    """Implementation of the 'Resources1' model.
    ...
    def __init__(
        ...
        """Initialize a Resources1 instance."""
    ...
    def from_dictionary(cls,
        ...
        priv =\
            dictionary.get("priv")\
            if "priv" in dictionary.keys()\
                else APIHelper.SKIP
        resource_name =\
            dictionary.get("resource_name")\
            if dictionary.get("resource_name")\
                else APIHelper.SKIP
        id =\
            dictionary.get("id")\
        ...
        last_used_date =\
            ...
            if "last_used_date" in dictionary.keys()\
                else APIHelper.SKIP
        created_ts =\
    ...
    def __repr__(self):
        ...
        _last_used_date=(
            self.last_used_date
            if hasattr(self, "last_used_date")
            else None
        )
        _created_ts=(
            self.created_ts
        ...
        return (
            ...
            f"title={_title!r}, "
            f"priv={_priv!r}, "
            f"resource_name={_resource_name!r}, "
            f"id={_id!r}, "
            f"last_used_date={_last_used_date!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"title={_title!s}, "
            f"priv={_priv!s}, "
            f"resource_name={_resource_name!s}, "
            f"id={_id!s}, "
            f"last_used_date={_last_used_date!s}, "
