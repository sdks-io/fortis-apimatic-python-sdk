...
class List5(object):
    ...
    def __init__(
        ...
        if product_token is not APIHelper.SKIP:
    ...
    def __repr__(self):
        ...
        _product_file=(
            self.product_file
            if hasattr(self, "product_file")
            else None
        )
        _product_accountvault=(
            self.product_accountvault
            if hasattr(self, "product_accountvault")
            else None
        )
        _product_token=(
            self.product_token
            if hasattr(self, "product_token")
            else None
        )
        _product_recurring=(
            self.product_recurring
            if hasattr(self, "product_recurring")
            else None
        )
        _tags=(
            self.tags
        ...
        return (
            ...
            f"product_file={_product_file!r}, "
            f"product_accountvault={_product_accountvault!r}, "
            f"product_token={_product_token!r}, "
            f"product_recurring={_product_recurring!r}, "
            f"tags={_tags!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"product_file={_product_file!s}, "
            f"product_accountvault={_product_accountvault!s}, "
            f"product_token={_product_token!s}, "
            f"product_recurring={_product_recurring!s}, "
            f"tags={_tags!s}, "
