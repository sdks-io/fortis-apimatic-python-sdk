...
class TerminalManufacturer1(object):
    """Implementation of the 'TerminalManufacturer1' model.

    Attributes:
        title (str): Terminal Manufacturer Title
        idtype (Idtype): The model property of type Idtype.
    ...
    def __init__(
        ...
        """Initialize a TerminalManufacturer1 instance."""
