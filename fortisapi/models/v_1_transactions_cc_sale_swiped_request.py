...
class V1TransactionsCcSaleSwipedRequest(object):
    """Implementation of the 'V1 Transactions Cc Sale Swiped Request' model.
    ...
    def __init__(
        ...
        """Initialize a V1TransactionsCcSaleSwipedRequest instance."""
