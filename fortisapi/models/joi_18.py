...
class Joi18(object):
    """Implementation of the 'Joi18' model.

    Attributes:
        conditions (Conditions18 | Conditions181 | Conditions4 | Conditions41 |
            Conditions42 | Conditions43 | None): The model property of type
            Conditions18 | Conditions181 | Conditions4 | Conditions41 | Conditions42
            | Conditions43 | None.
    ...
    def from_dictionary(cls,
        ...
        conditions = APIHelper.deserialize_union_type(
            UnionTypeLookUp.get("Joi18Conditions"),
