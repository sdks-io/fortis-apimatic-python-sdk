...
class ActiveNotificationAlert(object):
    ...
    def from_dictionary(cls,
        ...
        date_start =\
            ...
            if dictionary.get("date_start")\
                else APIHelper.SKIP
        date_end =\
            dictionary.get("date_end")\
            if dictionary.get("date_end")\
                else APIHelper.SKIP
        user_location =\
            dictionary.get("user_location")\
            if "user_location" in dictionary.keys()\
                else APIHelper.SKIP
        user_contact =\
            dictionary.get("user_contact")\
            if "user_contact" in dictionary.keys()\
                else APIHelper.SKIP
        include_children =\
            dictionary.get("include_children")\
            if "include_children" in dictionary.keys()\
                else APIHelper.SKIP
        alert_type =\
        ...
        alert_message =\
            ...
            if "alert_message" in dictionary.keys()\
                else APIHelper.SKIP
        id =\
            dictionary.get("id")\
    ...
    def __repr__(self):
        ...
        _user_location=(
            self.user_location
            if hasattr(self, "user_location")
            else None
        )
        _user_contact=(
            self.user_contact
            if hasattr(self, "user_contact")
            else None
        )
        _include_children=(
        ...
        return (
            ...
            f"date_start={_date_start!r}, "
            f"date_end={_date_end!r}, "
            f"user_location={_user_location!r}, "
            f"user_contact={_user_contact!r}, "
            f"include_children={_include_children!r}, "
            f"alert_type={_alert_type!r}, "
            f"alert_type_id={_alert_type_id!r}, "
            f"description={_description!r}, "
            f"alert_message={_alert_message!r}, "
            f"id={_id!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"date_start={_date_start!s}, "
            f"date_end={_date_end!s}, "
            f"user_location={_user_location!s}, "
            f"user_contact={_user_contact!s}, "
            f"include_children={_include_children!s}, "
            f"alert_type={_alert_type!s}, "
            f"alert_type_id={_alert_type_id!s}, "
            f"description={_description!s}, "
            f"alert_message={_alert_message!s}, "
            f"id={_id!s}, "
