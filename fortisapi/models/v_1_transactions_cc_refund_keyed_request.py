...
class V1TransactionsCcRefundKeyedRequest(object):
    ...
    Attributes:
        ...
        account_number (str | None): For CC transactions, a credit card number. For
            ACH transactions, a bank account number. >String lengths are conditional,
            CC should be 13-19 and ACH should be 4-19. Required if account_vault_id ,
    ...
    def from_dictionary(cls,
        ...
        account_number = APIHelper.deserialize_union_type(
            UnionTypeLookUp.get("V1TransactionsCcRefundKeyedRequestAccountNumber"),
            dictionary.get("account_number"),
            False)\
            if dictionary.get("account_number") is not None\
            else APIHelper.SKIP
        cvv =\
            dictionary.get("cvv")\
        ...
        exp_date = APIHelper.deserialize_union_type(
            ...
            False)\
            if dictionary.get("exp_date") is not None\
            else APIHelper.SKIP
        track_data =\
