...
class Owner(object):
    ...
    Attributes:
        ...
        is_controller (bool): Flag indicating whether this owner is the control
            owner. Maximum of 1 owner can be marked as control.. >Flag indicating
            whether this owner is the control owner. Maximum of 1 owner can be marked
            as control. >
        is_signer (bool): Flag indicating whether or not the owner is a signer for
    ...
    def from_dictionary(cls,
        ...
        state_province =\
            ...
            if dictionary.get("state_province")\
                else None
        postal_code =\
        ...
        ownership_percent =\
            ...
            if dictionary.get("ownership_percent")\
                else None
        phone_number =\
        ...
        is_controller =\
            ...
            if "is_controller" in dictionary.keys()\
                else None
        is_signer =\
            dictionary.get("is_signer")\
            if "is_signer" in dictionary.keys()\
                else None
        middle_name =\
    ...
    def __repr__(self):
        ...
        _address_line_2=self.address_line_2
        _city=self.city
        _state_province=self.state_province
        _postal_code=self.postal_code
        _country_code=self.country_code
        _ssn=self.ssn
        _ownership_percent=self.ownership_percent
        _phone_number=self.phone_number
        _email_address=self.email_address
        _is_controller=self.is_controller
        _is_signer=self.is_signer
        ...
        return (
            ...
            f"is_controller={_is_controller!r}, "
            f"is_signer={_is_signer!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"is_controller={_is_controller!s}, "
            f"is_signer={_is_signer!s}, "
