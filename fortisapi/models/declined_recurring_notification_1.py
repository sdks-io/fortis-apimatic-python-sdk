...
class DeclinedRecurringNotification1(object):
    """Implementation of the 'DeclinedRecurringNotification1' model.
    ...
    def __init__(
        ...
        """Initialize a DeclinedRecurringNotification1 instance."""
    ...
    def from_dictionary(cls,
        ...
        declined_transaction_id =\
            ...
            if "declined_transaction_id" in dictionary.keys()\
                else APIHelper.SKIP
        payment_transaction_id =\
            dictionary.get("payment_transaction_id")\
            if "payment_transaction_id" in dictionary.keys()\
                else APIHelper.SKIP
        created_ts =\
    ...
    def __repr__(self):
        ...
        _declined_transaction_id=(
            self.declined_transaction_id
            if hasattr(self, "declined_transaction_id")
            else None
        )
        _payment_transaction_id=(
            self.payment_transaction_id
            if hasattr(self, "payment_transaction_id")
            else None
        )
        _created_ts=(
            self.created_ts
        ...
        return (
            ...
            f"id={_id!r}, "
            f"declined_transaction_id={_declined_transaction_id!r}, "
    ...
    def __str__(self):
        ...
        return (
            f"{self.__class__.__name__}("
            f"id={_id!s}, "
            f"declined_transaction_id={_declined_transaction_id!s}, "
