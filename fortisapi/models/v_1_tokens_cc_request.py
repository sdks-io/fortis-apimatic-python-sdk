...
from fortisapi.models.joi_19 import Joi19


class V1TokensCcRequest(object):
    """Implementation of the 'V1TokensCcRequest' model.
    ...
    Attributes:
        ...
        joi (Joi19): The model property of type Joi19.
