...
class FilterBy(object):
    ...
    def from_dictionary(cls,
        ...
        operator = APIHelper.deserialize_union_type(
            UnionTypeLookUp.get("FilterByOperator"),
            dictionary.get("operator"),
            False)\
            if dictionary.get("operator") is not None\
            else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(
                ...
                and (UnionTypeLookUp.get("FilterByOperator")
                .validate(dictionary.operator).is_valid) \
                and (UnionTypeLookUp.get("FilterByValue")
        ...
        return APIHelper.is_valid_type(
            ...
            and (UnionTypeLookUp.get("FilterByOperator")
            .validate(dictionary.get("operator")).is_valid) \
            and (UnionTypeLookUp.get("FilterByValue")
