...
from fortisapi.models.joi_18 import Joi18
...
class V1TokensAchRequest(object):
    ...
    Attributes:
        ...
        joi (Joi18): The model property of type Joi18.
        account_type (AccountType13Enum): Account type >For ACH, must be provided as
            either 'checking' or 'savings'. For CC, field is read only. System will
            identify card_type and generate a value for this field automatically.
            i.e. visa, mc, disc, amex, jcb, diners. >
        is_company (bool): This identifies whether the ACH account belongs to a
            company or individual. This can affect which SEC code is used when
