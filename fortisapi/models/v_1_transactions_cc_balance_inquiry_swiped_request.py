...
class V1TransactionsCcBalanceInquirySwipedRequest(object):
    """Implementation of the 'V1TransactionsCcBalanceInquirySwipedRequest' model.
    ...
    def __init__(
        ...
        """Initialize a V1TransactionsCcBalanceInquirySwipedRequest instance."""
