...
class V1TokensTerminalAsyncRequest(object):
    """Implementation of the 'V1 Tokens Terminal Async Request' model.
    ...
    Attributes:
        ...
        action (str): Used for the Create Terminal endpoint. Valid value 'store'
    ...
    def __init__(
        ...
        """Initialize a V1TokensTerminalAsyncRequest instance."""
