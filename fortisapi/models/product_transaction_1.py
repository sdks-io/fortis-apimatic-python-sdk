...
from fortisapi.models.batch_risk_config_1 import (
    BatchRiskConfig1,
)
from fortisapi.models.level_3_default_1 import (
    Level3Default1,
)
...
class ProductTransaction1(object):
    ...
    Attributes:
        ...
        industry_type (Any): The model property of type Any.
        title (str): Title
        payment_method (PaymentMethod): The model property of type PaymentMethod.
        processor (Any): The model property of type Any.
        mcc (str): MCC
        tax_surcharge_config (Any): The model property of type Any.
        terminal_id (str): Terminal ID
        partner (Any): The model property of type Any.
        ...
        default_transaction_type (Any): The model property of type Any.
        ...
        level_3_default (Level3Default1): The model property of type Level3Default1.
        cau_subscribe_type_id (Any): The model property of type Any.
        ...
        batch_risk_config (BatchRiskConfig1): The model property of type
            BatchRiskConfig1.
        ...
        cau_subscribe_type_code (Any): The model property of type Any.
    ...
    def __init__(
        ...
        mcc=APIHelper.SKIP,
        tax_surcharge_config=APIHelper.SKIP,
        ...
        if mcc is not APIHelper.SKIP:
            self.mcc = mcc
        if tax_surcharge_config is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        industry_type =\
            ...
            if dictionary.get("industry_type")\
                else APIHelper.SKIP
        title =\
        ...
        default_transaction_type =\
            ...
            if dictionary.get("default_transaction_type")\
                else APIHelper.SKIP
        username =\
        ...
        cau_subscribe_type_code =\
            ...
            if dictionary.get("cau_subscribe_type_code")\
                else APIHelper.SKIP
        merchant_code =\
