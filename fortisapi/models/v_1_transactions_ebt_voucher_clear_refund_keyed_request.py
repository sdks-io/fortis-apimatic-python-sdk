...
class V1TransactionsEbtVoucherClearRefundKeyedRequest(object):
    """Implementation of the 'V1TransactionsEbtVoucherClearRefundKeyedRequest' model.
    ...
    def __init__(
        ...
        """Initialize a V1TransactionsEbtVoucherClearRefundKeyedRequest instance."""
