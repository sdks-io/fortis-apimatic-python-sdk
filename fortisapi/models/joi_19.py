...
class Joi19(object):
    """Implementation of the 'Joi19' model.

    Attributes:
        conditions (Conditions18 | Conditions191 | Conditions4 | Conditions41 |
    ...
    def from_dictionary(cls,
        ...
        conditions = APIHelper.deserialize_union_type(
            UnionTypeLookUp.get("Joi19Conditions"),
