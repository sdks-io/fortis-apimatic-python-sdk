...
class V1TerminalsRequest1(object):
    """Implementation of the 'V1TerminalsRequest1' model.
    ...
    Attributes:
        ...
        terminal_manufacturer_code (Any): The model property of type Any.
    ...
    def from_dictionary(cls,
        ...
        terminal_application_id =\
            ...
            if "terminal_application_id" in dictionary.keys()\
                else APIHelper.SKIP
        terminal_cvm_id =\
        ...
        local_ip_address =\
            ...
            if "local_ip_address" in dictionary.keys()\
                else APIHelper.SKIP
        port =\
            dictionary.get("port")\
        ...
        serial_number =\
            ...
            if "serial_number" in dictionary.keys()\
                else APIHelper.SKIP
        terminal_number =\
            dictionary.get("terminal_number")\
            if "terminal_number" in dictionary.keys()\
                else APIHelper.SKIP
        terminal_timeouts =\
