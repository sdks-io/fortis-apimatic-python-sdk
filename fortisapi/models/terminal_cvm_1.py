...
class TerminalCvm1(object):
    """Implementation of the 'TerminalCvm1' model.
    ...
    def __init__(
        ...
        """Initialize a TerminalCvm1 instance."""
    ...
    def from_dictionary(cls,
        ...
        contact_data =\
            ...
            if "contact_data" in dictionary.keys()\
                else APIHelper.SKIP
        contactless_data =\
            dictionary.get("contactless_data")\
            if "contactless_data" in dictionary.keys()\
                else APIHelper.SKIP
        id =\
            dictionary.get("id")\
    ...
    def __repr__(self):
        ...
        _contact_data=(
            self.contact_data
            if hasattr(self, "contact_data")
            else None
        )
        _contactless_data=(
            self.contactless_data
            if hasattr(self, "contactless_data")
            else None
        )
        _id=(
            self.id
        ...
        return (
            ...
            f"title={_title!r}, "
            f"contact_data={_contact_data!r}, "
            f"contactless_data={_contactless_data!r}, "
            f"id={_id!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"title={_title!s}, "
            f"contact_data={_contact_data!s}, "
            f"contactless_data={_contactless_data!s}, "
            f"id={_id!s}, "
