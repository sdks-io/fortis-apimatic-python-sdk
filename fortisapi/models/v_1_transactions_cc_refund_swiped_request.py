...
class V1TransactionsCcRefundSwipedRequest(object):
    """Implementation of the 'V1 Transactions Cc Refund Swiped Request' model.
    ...
    def __init__(
        ...
        """Initialize a V1TransactionsCcRefundSwipedRequest instance."""
