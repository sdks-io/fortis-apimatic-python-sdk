...
class V1TransactionsCcForceSwipedRequest(object):
    """Implementation of the 'V1 Transactions Cc Force Swiped Request' model.
    ...
    def __init__(
        ...
        """Initialize a V1TransactionsCcForceSwipedRequest instance."""
