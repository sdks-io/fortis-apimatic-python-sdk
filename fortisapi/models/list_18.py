...
from fortisapi.models.quick_invoice_1 import (
    QuickInvoice1,
)
...
from fortisapi.models.saved_account_1 import (
    SavedAccount1,
)
from fortisapi.models.signature_1 import Signature1
from fortisapi.models.status_7 import Status7
from fortisapi.models.surcharge_1 import Surcharge1
from fortisapi.models.surcharge_transaction_1 import (
...
from fortisapi.models.transaction_batch_1 import (
    TransactionBatch1,
)
...
from fortisapi.models.type_7 import Type7
...
class List18(object):
    ...
    Attributes:
        ...
        quick_invoice_id (str): Can be used to associate a transaction to a Quick
            ...
            automatically.
        recurring (Recurring): The model property of type Recurring.
        ...
        avs (Any): The model property of type Any.
        ...
        emv_receipt_data (Any): The model property of type Any.
        ...
        payment_method (PaymentMethod9): The model property of type PaymentMethod9.
        ...
        reason_code_id (Any): The model property of type Any.
        ...
        type_id (Any): The model property of type Any.
        ...
        quick_invoice (QuickInvoice1): The model property of type QuickInvoice1.
        ...
        tag_transactions (List[TagTransaction]): TagTransaction Information on
            `expand`
        declined_recurring_notification (DeclinedRecurringNotification1): The model
            property of type DeclinedRecurringNotification1.
        payment_recurring_notification (PaymentRecurringNotification1): The model
            property of type PaymentRecurringNotification1.
        developer_company (DeveloperCompany1): The model property of type
            DeveloperCompany1.
        terminal (Terminal2): The model property of type Terminal2.
        hosted_payment_page (HostedPaymentPage1): The model property of type
            HostedPaymentPage1.
        transaction_level_3 (Data29): The model property of type Data29.
        ...
        surcharge_transaction (SurchargeTransaction1): The model property of type
            SurchargeTransaction1.
        ...
        transaction_batch (TransactionBatch1): The model property of type
            TransactionBatch1.
        ...
        currency_type (CurrencyType1): The model property of type CurrencyType1.
        ...
        rejected_transaction_ach_retries (List[RejectedTransactionAchRetry]): [object
            Object]
        return_fee_transaction_ach_retry (RejectedTransactionAchRetry): The model
            property of type RejectedTransactionAchRetry.
        retry_transaction_ach_retry (RejectedTransactionAchRetry): The model property
            of type RejectedTransactionAchRetry.
        is_retriable (bool): [object Object]
        saved_account (SavedAccount1): The model property of type SavedAccount1.
    ...
    def from_dictionary(cls,
        ...
        emv_receipt_data =\
            ...
            if dictionary.get("emv_receipt_data")\
                else APIHelper.SKIP
        first_six =\
        ...
        trx_source_id =\
            ...
            if dictionary.get("trx_source_id")\
                else APIHelper.SKIP
        routing_number =\
        ...
        trx_source_code =\
            ...
            if dictionary.get("trx_source_code")\
                else APIHelper.SKIP
        paylink_id =\
        ...
        if dictionary.get("transaction_histories") is not None:
            ...
            transaction_histories = APIHelper.SKIP
        surcharge_transaction =\
            SurchargeTransaction1.from_dictionary(
        ...
        mtype =\
            Type7.from_dictionary(
                dictionary.get("type"))\
                if "type" in dictionary.keys()\
                else APIHelper.SKIP
        status =\
            Status7.from_dictionary(
                dictionary.get("status"))\
                if "status" in dictionary.keys()\
                else APIHelper.SKIP
        transaction_batch =\
            TransactionBatch1.from_dictionary(
        ...
        if dictionary.get("rejected_transaction_ach_retries") is not None:
            ...
            rejected_transaction_ach_retries = APIHelper.SKIP
        return_fee_transaction_ach_retry =\
            RejectedTransactionAchRetry.from_dictionary(
