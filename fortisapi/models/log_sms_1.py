...
class LogSms1(object):
    """Implementation of the 'LogSms1' model.
    ...
    def from_dictionary(cls,
        ...
        reason_model_id =\
            ...
            if dictionary.get("reason_model_id")\
                else APIHelper.SKIP
        provider_id =\
            dictionary.get("provider_id")\
            if dictionary.get("provider_id")\
                else APIHelper.SKIP
        status =\
        ...
        sender =\
            ...
            if dictionary.get("sender")\
                else APIHelper.SKIP
        recipient =\
            dictionary.get("recipient")\
            if dictionary.get("recipient")\
                else APIHelper.SKIP
        created_ts =\
