...
from fortisapi.models.billing_address_9 import (
    BillingAddress9,
)
...
class Data24(object):
    ...
    Attributes:
        account_holder_name (str): Account holder name >The Name as it appears on
            Card. >
        exp_date (str): The Expiration Date for the credit card.
        cvv (str): CVV
        account_number (str): Account number >A credit card number. Length 13-19. >
        billing_address (BillingAddress9): The model property of type BillingAddress9.
        contact_id (str): Used to associate the Ticket with a Contact.
        contact_api_id (str): Used to associate the Ticket with a Contact.
        location_id (str | None): A valid Location Id associated with the Contact for
            this Ticket
    ...
    def from_dictionary(cls,
        ...
        billing_address =\
            BillingAddress9.from_dictionary(
        ...
        location_id = APIHelper.deserialize_union_type(
            UnionTypeLookUp.get("Data24LocationId"),
            dictionary.get("location_id"),
            False)\
            if dictionary.get("location_id") is not None\
            else APIHelper.SKIP
        location_api_id =\
