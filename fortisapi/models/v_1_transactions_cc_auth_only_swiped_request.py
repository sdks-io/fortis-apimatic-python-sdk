...
class V1TransactionsCcAuthOnlySwipedRequest(object):
    """Implementation of the 'V1 Transactions Cc Auth Only Swiped Request' model.
    ...
    def __init__(
        ...
        """Initialize a V1TransactionsCcAuthOnlySwipedRequest instance."""
