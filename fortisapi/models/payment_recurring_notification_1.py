...
class PaymentRecurringNotification1(object):
    """Implementation of the 'PaymentRecurringNotification1' model.
    ...
    def __init__(
        ...
        """Initialize a PaymentRecurringNotification1 instance."""
