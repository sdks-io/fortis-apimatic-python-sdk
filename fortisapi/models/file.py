...
class File(object):
    ...
    def from_dictionary(cls,
        ...
        product_file_id =\
            ...
            if "product_file_id" in dictionary.keys()\
                else APIHelper.SKIP
        file_category_id =\
            dictionary.get("file_category_id")\
            if "file_category_id" in dictionary.keys()\
                else APIHelper.SKIP
        visibility_group_id =\
            dictionary.get("visibility_group_id")\
            if "visibility_group_id" in dictionary.keys()\
                else APIHelper.SKIP
        file_description =\
            dictionary.get("file_description")\
            if "file_description" in dictionary.keys()\
                else APIHelper.SKIP
        id =\
            dictionary.get("id")\
        ...
        file_name =\
            ...
            if "file_name" in dictionary.keys()\
                else APIHelper.SKIP
        file_extension =\
            dictionary.get("file_extension")\
            if "file_extension" in dictionary.keys()\
                else APIHelper.SKIP
        file_size_bytes =\
            dictionary.get("file_size_bytes")\
            if "file_size_bytes" in dictionary.keys()\
                else APIHelper.SKIP
        created_ts =\
    ...
    def __repr__(self):
        ...
        _product_file_id=(
            self.product_file_id
            if hasattr(self, "product_file_id")
            else None
        )
        _file_category_id=(
            self.file_category_id
            if hasattr(self, "file_category_id")
            else None
        )
        _visibility_group_id=(
            self.visibility_group_id
            if hasattr(self, "visibility_group_id")
            else None
        )
        _file_description=(
        ...
        _file_size_bytes=(
            ...
            if hasattr(self, "file_size_bytes")
            else None
        )
        _created_ts=(
            self.created_ts
        ...
        return (
            ...
            f"product_file_id={_product_file_id!r}, "
            f"file_category_id={_file_category_id!r}, "
            f"visibility_group_id={_visibility_group_id!r}, "
            f"file_description={_file_description!r}, "
            f"id={_id!r}, "
            f"file_name={_file_name!r}, "
            f"file_extension={_file_extension!r}, "
            f"file_size_bytes={_file_size_bytes!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"product_file_id={_product_file_id!s}, "
            f"file_category_id={_file_category_id!s}, "
            f"visibility_group_id={_visibility_group_id!s}, "
            f"file_description={_file_description!s}, "
            f"id={_id!s}, "
            f"file_name={_file_name!s}, "
            f"file_extension={_file_extension!s}, "
            f"file_size_bytes={_file_size_bytes!s}, "
