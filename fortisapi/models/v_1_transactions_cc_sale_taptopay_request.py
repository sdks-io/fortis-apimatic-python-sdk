...
class V1TransactionsCcSaleTaptopayRequest(object):
    """Implementation of the 'V1 Transactions Cc Sale Taptopay Request' model.
    ...
    def __init__(
        ...
        """Initialize a V1TransactionsCcSaleTaptopayRequest instance."""
