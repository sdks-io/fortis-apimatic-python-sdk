...
class DeclinedRecurringTransactionsController(BaseController):
    ...
    def get_one_declined_recurring_transaction(self,
        ...
        Args:
            ...
            expand (List[Expand5Enum], optional): Most endpoints in the API have a
        ...
        Returns:
            ResponseDeclinedRecurringTransaction: Response from the API. OK
    ...
    def list_all_declined_recurring_transactions(self,
        ...
        Args:
            ...
            fields (List[Field30Enum], optional): You can use any `field_name` from
                this endpoint results to filter the list of fields returned on the
                response.

        Returns:
            ResponseDeclinedRecurringTransactionsCollection: Response from the API. OK
    ...
    def create_a_payment(self,
        ...
        Args:
            body (V1DeclinedRecurringTransactionPaymentsRequest): The request body
                parameter.

        Returns:
            ResponseDeclinedRecurringTransactionPayment: Response from the API.
                Created
    ...
    def resend_the_transaction(self,
        ...
        Returns:
            ResponseDeclinedRecurringTransactionResend: Response from the API. OK
