...
class SignaturesController(BaseController):
    ...
    def create_a_new_signature_record(self,
        ...
        Args:
            ...
            expand (List[Expand34Enum], optional): Most endpoints in the API have a
        ...
        Returns:
            ResponseSignature: Response from the API. Created
    ...
    def list_all_signatures_record(self,
        ...
        Args:
            ...
            fields (List[Field45Enum], optional): You can use any `field_name` from
                this endpoint results to filter the list of fields returned on the
                response.

        Returns:
            ResponseSignaturesCollection: Response from the API. OK
    ...
    def view_single_signature_record(self,
        ...
        Returns:
            ResponseSignature: Response from the API. OK
