...
class TicketsController(BaseController):
    ...
    def create_a_ticket_record(self,
        ...
        Args:
            ...
            expand (List[Expand44Enum], optional): Most endpoints in the API have a
        ...
        Returns:
            ResponseTicket: Response from the API. Created
    ...
    def list_all_tickets_related(self,
        ...
        Args:
            ...
            fields (List[Field51Enum], optional): You can use any `field_name` from
                this endpoint results to filter the list of fields returned on the
                response.

        Returns:
            ResponseTicketsCollection: Response from the API. OK
    ...
    def view_single_ticket_record(self,
        ...
        Args:
            ticket_id (str): A unique, system-generated identifier for the Ticket.
            expand (List[Expand44Enum], optional): Most endpoints in the API have a
                way to retrieve extra data related to the current record being
                retrieved. For example, if the API request is for the accountvaults
                endpoint, and the end user also needs to know which contact the token
        ...
        Returns:
            ResponseTicket: Response from the API. OK
