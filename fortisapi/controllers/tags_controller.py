...
class TagsController(BaseController):
    ...
    def create_a_new_tag(self,
        ...
        Args:
            ...
            expand (List[Expand37Enum], optional): Most endpoints in the API have a
        ...
        Returns:
            ResponseTag: Response from the API. Created
    ...
    def list_all_tags_related(self,
        ...
        Args:
            ...
            fields (List[Field47Enum], optional): You can use any `field_name` from
                this endpoint results to filter the list of fields returned on the
                response.

        Returns:
            ResponseTagsCollection: Response from the API. OK
    ...
    def delete_tag_record(self,
        ...
        Returns:
            ResponseTag: Response from the API. No Content
    ...
    def view_single_tags_record(self,
        ...
        Returns:
            ResponseTag: Response from the API. OK
