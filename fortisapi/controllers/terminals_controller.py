...
class TerminalsController(BaseController):
    ...
    def create_a_new_terminal_device(self,
        ...
        Args:
            ...
            expand (List[Expand40Enum], optional): Most endpoints in the API have a
        ...
        Returns:
            ResponseTerminal: Response from the API. Created
    ...
    def list_all_terminals_related(self,
        ...
        Args:
            ...
            fields (List[Field49Enum], optional): You can use any `field_name` from
                this endpoint results to filter the list of fields returned on the
                response.

        Returns:
            ResponseTerminalsCollection: Response from the API. OK
    ...
    def view_single_terminals_record(self,
        ...
        Returns:
            ResponseTerminal: Response from the API. OK
