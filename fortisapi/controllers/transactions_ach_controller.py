...
class TransactionsAchController(BaseController):
    ...
    def ach_credit_previous_transaction(self,
        ...
        ACH Transaction that is intended for a Blind Refund, where using a previous
        transaction id to re process. Must have Fortis approval prior to use.
    ...
    def ach_credit_tokenized(self,
        ...
        where a previous transaction id is not known. Must have approval prior to use.
